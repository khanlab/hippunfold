rule create_native_coord_ref:
    ...
    output:
        nii = bids(root=work,datatype='seg',space='corobl',hemi='{hemi}',suffix='refcoords.nii.gz',**config['subj_wildcards'])
    group: 'subj'
...
rule create_warps:
    input:
        unfold_ref_nii = bids(root=work,space='unfold',datatype='seg',suffix='refvol.nii.gz',**config['subj_wildcards']),
        unfold_phys_coords_nii = bids(root=work,space='unfold',datatype='seg',suffix='refcoords.nii.gz',**config['subj_wildcards']),
        coords_ap = bids(root=work,datatype='seg',dir='AP',suffix='coords.nii.gz',desc='laplace',space='corobl',hemi='{hemi}', **config['subj_wildcards']),
        ...
        native_ref_coords_nii = bids(root=work,datatype='seg',space='corobl',hemi='{hemi}',suffix='refcoords.nii.gz',**config['subj_wildcards'])
    params:
        interp_method =  'linear'
    resources:
        mem_mb = 16000
    output:
        warp_unfold2native = bids(root=work,datatype='seg',**config['subj_wildcards'],suffix='xfm.nii.gz',hemi='{hemi,Lflip|R}',from_='unfold',to='corobl',mode='surface'),
        warp_native2unfold = bids(root=work,datatype='seg',**config['subj_wildcards'],suffix='xfm.nii.gz',hemi='{hemi,Lflip|R}',from_='corobl',to='unfold',mode='surface'),
        warpitk_unfold2native = bids(root=work,datatype='seg',**config['subj_wildcards'],suffix='xfm.nii.gz',hemi='{hemi,Lflip|R}',from_='unfold',to='corobl',mode='image'),

        warpitk_native2unfold = bids(root=work,datatype='seg',**config['subj_wildcards'],suffix='xfm.nii.gz',hemi='{hemi,Lflip|R}',from_='corobl',to='unfold',mode='image')
    group: 'subj'
...
rule compose_warps_corobl2unfold_lhemi:
    ...
    input:
        native2unfold = bids(root=work,datatype='seg',**config['subj_wildcards'],suffix='xfm.nii.gz',hemi='Lflip',from_='corobl',to='unfold',mode='image'),
        ref = bids(root=work,space='unfold',datatype='seg',suffix='refvol.nii.gz',**config['subj_wildcards']),
...
rule compose_warps_unfold2corobl_lhemi:
    ...
    input:
        unfold2native = bids(root=work,datatype='seg',**config['subj_wildcards'],suffix='xfm.nii.gz',hemi='Lflip',from_='unfold',to='corobl',mode='image'),
        flipLR_xfm = os.path.join(workflow.basedir,'..','resources','desc-flipLR_type-itk_xfm.txt'),
        unfold_ref = bids(root=work,space='unfold',datatype='seg',suffix='refvol.nii.gz',**config['subj_wildcards']),
        ref = bids(root=work,datatype='seg',dir='AP',suffix='coords.nii.gz',desc='laplace',space='corobl',hemi='L', **config['subj_wildcards']),
    output:
        unfold2corobl = bids(root=work,datatype='seg',**config['subj_wildcards'],suffix='xfm.nii.gz',hemi='L',from_='unfold',to='corobl',mode='image')
...
rule compose_warps_t1_to_unfold:
    ...
    output: 
        bids(root=root,datatype='seg',**config['subj_wildcards'],suffix='xfm.nii.gz',hemi='{hemi}',from_='T1w',to='unfold',mode='image')
    container: config['singularity']['ants']
    group: 'subj'
...
rule compose_warps_unfold_to_cropt1:
    ...
    input:
        unfold2corobl = bids(root=root,datatype='seg',**config['subj_wildcards'],suffix='xfm.nii.gz',hemi='{hemi}',from_='unfold',to='corobl',mode='image'),
        ref = bids(root=work,datatype='seg',suffix='cropref.nii.gz', space='T1w',hemi='{hemi}', **config['subj_wildcards']),
        t1w2corobl = bids(root=work,datatype='anat',**config['subj_wildcards'],suffix='xfm.txt',from_='T1w',to='corobl',desc='affine',type_='itk'),
        unfold_ref = bids(root=work,space='unfold',datatype='seg',suffix='refvol.nii.gz',**config['subj_wildcards']),
    output: 
        unfold2cropt1 = bids(root=root,datatype='seg',**config['subj_wildcards'],suffix='xfm.nii.gz',hemi='{hemi}',from_='unfold',to='T1w',mode='image')
    container: config['singularity']['ants']
    group: 'subj'
