...
rule create_spec_file_hipp:
    input:
        ...
        subfields=lambda wildcards: inputs[get_modality_key(config["modality"])].expand(
            bids(
                root=root,
                datatype="surf",
                den="{density}",
        ...
        cifti_metrics=lambda wildcards: inputs[get_modality_key(config["modality"])].expand(
            bids(
                root=root,
                datatype="surf",
                den="{density}",
        ...
        cifti_labels=lambda wildcards: inputs[get_modality_key(config["modality"])].expand(
            bids(
                root=root,
                datatype="surf",
                den="{density}",
