...
vertices[:, 0] = ap * snakemake.params.vertspace["extent"][0]# + snakemake.params.vertspace["origin"][0]
vertices[:, 1] = pd * snakemake.params.vertspace["extent"][1]# + snakemake.params.vertspace["origin"][1]
