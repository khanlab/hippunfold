...
ATLAS_DENSITY_CHOICES = [
    ...
    "5k",
    "12k",
]  # note these are SUGGESTED NAMES and should be compared to actual surface properties generated by resample_to_density_mapping
RESAMPLING_FACTORS = [
    60,
    40,
    10,
]  # percent, relative to native (should be a list with the same length as ATLAS_DENSITY_CHOICES -1 )
