...
rule create_warps:
    ...
    output:
        warp_unfold2native=bids(
            root=work,
            **config["subj_wildcards"],
            suffix="autotop/Warp_unfold2native.nii",
            desc="cropped",
            space="corobl",
            hemi="{hemi,Lflip|R}",
            modality="{modality}"
        ...
        warp_native2unfold=bids(
            root=work,
            **config["subj_wildcards"],
            suffix="autotop/Warp_native2unfold.nii",
            desc="cropped",
            space="corobl",
            hemi="{hemi,Lflip|R}",
            modality="{modality}"
        ...
        warpitk_unfold2native=bids(
            root=work,
            **config["subj_wildcards"],
            suffix="autotop/WarpITK_unfold2native.nii",
            desc="cropped",
            space="corobl",
            hemi="{hemi,Lflip|R}",
            modality="{modality}"
        ...
        warpitk_native2unfold=bids(
            root=work,
            **config["subj_wildcards"],
            suffix="autotop/WarpITK_native2unfold.nii",
            desc="cropped",
            space="corobl",
            hemi="{hemi,Lflip|R}",
            modality="{modality}"
...
rule map_to_full_grid:
    ...
    params:
        ...
        script=os.path.join(
            config["snakemake_dir"], "workflow", "scripts", "mapUnfoldToFullGrid.sh"
        ),
        warp_dir=bids(
            root=work,
            **config["subj_wildcards"],
    ...
    output:
        warp_unfoldtemplate2unfold=bids(
            root=work,
            **config["subj_wildcards"],
            suffix="autotop/Warp_unfoldtemplate2unfold.nii",
            desc="cropped",
            space="corobl",
            hemi="{hemi,Lflip|R}",
            modality="{modality}"
        ),
        warp_unfold2unfoldtemplate=bids(
            root=work,
            **config["subj_wildcards"],
            suffix="autotop/Warp_unfold2unfoldtemplate.nii",
            desc="cropped",
            space="corobl",
            hemi="{hemi,Lflip|R}",
            modality="{modality}"
        ),
        warpitk_unfoldtemplate2unfold=bids(
            root=work,
            **config["subj_wildcards"],
            suffix="autotop/WarpITK_unfold2unfoldtemplate_0InverseWarp.nii.gz",
            desc="cropped",
            space="corobl",
            hemi="{hemi,Lflip|R}",
            modality="{modality}"
        ),
        warpitk_unfold2unfoldtemplate=bids(
            root=work,
            **config["subj_wildcards"],
            suffix="autotop/WarpITK_unfold2unfoldtemplate_0Warp.nii.gz",
            desc="cropped",
            space="corobl",
            hemi="{hemi,Lflip|R}",
            modality="{modality}"
    ...
    log:
        bids(
            ...
            **config["subj_wildcards"],
            ...
            hemi="{hemi,Lflip|R}",
            modality="seg{modality}",
            suffix="mapUnfoldToFullGrid.txt"
        ),
    shell:
...
rule compose_warps_corobl2unfold_rhemi:
    ...
    group:
        "subj"
    shell:
        "ComposeMultiTransform 3 {output.corobl2unfold} -R {input.ref} {input.unfold2unfoldtemplate} {input.native2unfold}"
...
rule compose_warps_corobl2unfold_lhemi:
    ...
    input:
        ...
        flipLR_xfm=os.path.join(
            config["snakemake_dir"], "resources", "desc-flipLR_type-itk_xfm.txt"
        ),
    output:
        corobl2unfold=bids(
            root=work,
    ...
    group:
        "subj"
    shell:
        "ComposeMultiTransform 3 {output.corobl2unfold} -R {input.ref} {input.unfold2unfoldtemplate} {input.native2unfold} {input.flipLR_xfm}"
