...
RUN bash -c "source ~/.bashrc && \
    ...
    ./hippunfold/run.py test_data/bids_singleT2w test_out participant  --modality T2w --hemi R --use-conda --conda-create-envs-only --cores all --conda-prefix /src/conda-envs --conda-frontend mamba && \
    ...
    ./hippunfold/run.py test_data/bids_dsegtissue_1hemi test_out participant  --modality dsegtissue --derivatives test_data/bids_dsegtissue_1hemi --hemi L --use-conda --conda-create-envs-only --cores all --conda-prefix /src/conda-envs --conda-frontend mamba && \
...
ENV SNAKEMAKE_PROFILE=/src/hippunfold/profiles/workflow/docker-conda
